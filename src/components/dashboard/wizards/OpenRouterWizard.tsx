...
export function OpenRouterWizard({ open, onOpenChange, onSuccess }: OpenRouterWizardProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md bg-card/95 backdrop-blur-xl border-2" style={{ borderColor: OPENROUTER_COLOR }}>
        <DialogHeader>
