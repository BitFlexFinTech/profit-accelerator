...
export const GeminiWizard = forwardRef<HTMLDivElement, GeminiWizardProps>(
  function GeminiWizard({ open, onOpenChange, onSuccess }, ref) {
    ...
    return (
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent ref={ref} className="sm:max-w-md bg-card/95 backdrop-blur-xl border-2" style={{ borderColor: GEMINI_COLOR }}>
          <DialogHeader>
...
GeminiWizard.displayName = 'GeminiWizard';
