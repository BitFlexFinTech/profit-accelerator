...
export const CerebrasWizard = forwardRef<HTMLDivElement, CerebrasWizardProps>(
  function CerebrasWizard({ open, onOpenChange, onSuccess }, ref) {
    ...
    return (
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent ref={ref} className="sm:max-w-md bg-card/95 backdrop-blur-xl border-2" style={{ borderColor: CEREBRAS_COLOR }}>
          <DialogHeader>
...
CerebrasWizard.displayName = 'CerebrasWizard';
